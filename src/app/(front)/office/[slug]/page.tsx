...
import OfficeFeature from "@/features/offices/components/OfficeFeature";
    ...
    <>
      ...
      >
        <div className="flex flex-col w-full rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
          ...
          <OfficeFeature features={office.features} />
          ...
          <div className="flex flex-col rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
            ...
            {office.isFullyBooked ? (
              <div className="flex flex-col gap-5">
                <p className="font-bold text-xl leading-[30px]">
                  Sorry. This office{" "}
                  <span className="text-[#FF2D2D]">fully booked</span>
                  at this moment, try next time.
                </p>
              </div>
            ) : (
              <div>
            ...
            <div className="flex flex-col gap-[14px]">
              ...
              {office.isFullyBooked ? (
                ...
                <a
                  target="_blank"
                  href={`https://wa.me/6282195220763?text=Saya ingin booking kantor *${office.title}* yang berlokasi di *${office.location}*`}
